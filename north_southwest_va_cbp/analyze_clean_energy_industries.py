...
def analyze_clean_energy_industries(filename, county_name):
...
def main():
    print("=" * 100)
    print("VIRGINIA CLEAN ENERGY & CARBON CAPTURE INDUSTRIES ANALYSIS")
    print("=" * 100)
    ...
    for county_file in SOUTHWEST_VA_COUNTIES:
        ...
        clean_energy_industries = analyze_clean_energy_industries(filename, county_name)
        ...
        for industry in clean_energy_industries:
            ...
            emp = industry['emp']
            payroll = industry['payann'] # Changed from 'payroll' to 'payann' to match original file
    ...
    # Regional summary
    print(f"\n{'='*100}")
    print(f"🌱 REGIONAL CLEAN ENERGY INDUSTRIES SUMMARY")
    print(f"{'='*100}")
    ...
    for county_name, industries in all_counties_data:
        for industry in industries:
            ...
            if naics in naics_summary:
                ...
                naics_summary[naics]['total_payroll'] += industry['payann'] # Changed from 'payroll' to 'payann'
