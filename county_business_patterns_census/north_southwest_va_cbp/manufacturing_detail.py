...
def get_manufacturing_category(naics_code):
    ...
    # Food Manufacturing
    elif naics_code.startswith('311'):
...
def analyze_manufacturing_detail(filename):
...
def main():
    ...
    for county_file in SOUTHWEST_VA_COUNTIES:
        ...
        manufacturing = analyze_manufacturing_detail(filename)
        ...
        for industry in manufacturing:
            category = get_manufacturing_category(industry['naics'])
    ...
    for county_name, industry in all_manufacturing:
        subsector = get_manufacturing_category(industry['naics'])
