...
url = "https://api.census.gov/data/timeseries/qwi/se?get=Emp&for=county:013&in=state:51&key=a19b29f73f2fb20843c8e5835a8d4c85c18467e4"

def fetch_qwi_data():
    """Fetch QWI data for Arlington County"""
    try:
...
def main():
    ...
    print("Arlington County, Virginia")
    print("=" * 60)
